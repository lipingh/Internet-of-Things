...
public class Cart {
     ...
     */
    //change XML to JSON format and delete the last comma to get the right json foramt
    public String toJSON() {
        ...
        }//delete the last comma to get the right json format
        json.append("]}");
