...
/*
 * Count down the specified item number from the shopping cart, via Ajax call
 * itemCode - product code of the item to minus
 */
// This is a new function to get request and send request to do the minus items
//Note: the code is follow the fucntion addToCart
